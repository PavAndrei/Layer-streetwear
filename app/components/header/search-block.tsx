...
export const SearchBlock = () => {
  return (
    <div className="flex items-center gap-5 w-full md:min-w-100 lg:min-w-140">
      <button className="hidden md:flex items-center gap-1 bg-lime-600 rounded px-2 py-1 hover:bg-lime-500 cursor-pointer transition-colors duration-200 ease-in">
